  ...
  return (
    ...
    <div className='auth-container'>
      <div className='auth-card'>
        <h2>Welcome Back</h2>
        <p className='subtitle'>Sign in to your TasteYum account</p>
        ...
        <form onSubmit={submitHandeler}>
          ...
          <div className="mb-4">
            ...
            <div className="input-group">
              ...
              <input type={showPassword ? "text" : "password"} className="form-control" placeholder="Enter your password" name="password" value={credentials.password} onChange={onChange} required />
